...
def configure_colorchooser_from_gconf(gconf_client, gconf_key, widget_id, default_value, widget_tree,
                                      default_alpha=None):
    g15uigconf.configure_colorchooser_from_gconf(gconf_client, gconf_key, widget_id, default_value, widget_tree,
                                                 default_alpha)
...
def configure_checkbox_from_gconf(gconf_client, gconf_key, widget_id, default_value, widget_tree, watch_changes=False):
    return g15uigconf.configure_checkbox_from_gconf(gconf_client, gconf_key, widget_id, default_value, widget_tree,
                                                    watch_changes)


def configure_text_from_gconf(gconf_client, gconf_key, widget_id, default_value, widget_tree, watch_changes=False):
    return g15uigconf.configure_text_from_gconf(gconf_client, gconf_key, widget_id, default_value, widget_tree,
                                                watch_changes)


def configure_radio_from_gconf(gconf_client, gconf_key, widget_ids, gconf_values, default_value, widget_tree,
                               watch_changes=False):
    return g15uigconf.configure_radio_from_gconf(gconf_client, gconf_key, widget_ids, gconf_values, default_value,
                                                 widget_tree, watch_changes)
