...
class G15Keyring():
    ...
    def find_secret(self, account, name, release_lock=True):
        ...
        try:
            ...
            text_widget.set_text("The account <b>%s</b> for the user <b>%s</b>.\n\
...
class G15AccountPreferences():
    ...
    def __init__(self, parent, gconf_client, gconf_key, file_path, item_name, default_refresh=60):
        ...
        self.update_adjustment.set_value(
            g15gconf.get_int_or_default(gconf_client, gconf_key + "/update_time", default_refresh))
    ...
    def _new_url(self, widget):
        ...
        self.account_list.set_cursor_on_cell(str(len(self.account_model) - 1),
                                             focus_column=self.account_list.get_column(0), focus_cell=self.url_renderer,
                                             start_editing=True)
