...
z10_action_keys = {g15driver.NEXT_SELECTION: g15actions.ActionBinding(g15driver.NEXT_SELECTION, [g15driver.G_KEY_L4],
                                                                      g15driver.KEY_STATE_UP),
                   g15driver.PREVIOUS_SELECTION: g15actions.ActionBinding(g15driver.PREVIOUS_SELECTION,
                                                                          [g15driver.G_KEY_L3], g15driver.KEY_STATE_UP),
                   g15driver.SELECT: g15actions.ActionBinding(g15driver.SELECT, [g15driver.G_KEY_L5],
                                                              g15driver.KEY_STATE_UP),
                   g15driver.MENU: g15actions.ActionBinding(g15driver.MENU, [g15driver.G_KEY_L1],
                                                            g15driver.KEY_STATE_UP),
                   g15driver.CLEAR: g15actions.ActionBinding(g15driver.CLEAR, [g15driver.G_KEY_L2],
                                                             g15driver.KEY_STATE_HELD),
                   g15driver.VIEW: g15actions.ActionBinding(g15driver.VIEW, [g15driver.G_KEY_L2],
                                                            g15driver.KEY_STATE_UP),
                   g15driver.NEXT_PAGE: g15actions.ActionBinding(g15driver.NEXT_PAGE, [g15driver.G_KEY_L4],
                                                                 g15driver.KEY_STATE_HELD),
                   g15driver.PREVIOUS_PAGE: g15actions.ActionBinding(g15driver.PREVIOUS_PAGE, [g15driver.G_KEY_L3],
                                                                     g15driver.KEY_STATE_HELD)
}
...
g13_key_layout = [
    [g15driver.G_KEY_G1, g15driver.G_KEY_G2, g15driver.G_KEY_G3, g15driver.G_KEY_G4, g15driver.G_KEY_G5,
     g15driver.G_KEY_G6, g15driver.G_KEY_G7],
    [g15driver.G_KEY_G8, g15driver.G_KEY_G9, g15driver.G_KEY_G10, g15driver.G_KEY_G11, g15driver.G_KEY_G12,
     g15driver.G_KEY_G13, g15driver.G_KEY_G14],
...
"""
g15_action_keys = {g15driver.NEXT_SELECTION: g15actions.ActionBinding(g15driver.NEXT_SELECTION, [g15driver.G_KEY_L4],
                                                                      g15driver.KEY_STATE_UP),
                   g15driver.PREVIOUS_SELECTION: g15actions.ActionBinding(g15driver.PREVIOUS_SELECTION,
                                                                          [g15driver.G_KEY_L3], g15driver.KEY_STATE_UP),
                   g15driver.SELECT: g15actions.ActionBinding(g15driver.SELECT, [g15driver.G_KEY_L5],
                   ...
                   g15driver.PREVIOUS_PAGE: g15actions.ActionBinding(g15driver.PREVIOUS_PAGE, [g15driver.G_KEY_L3],
                                                                     g15driver.KEY_STATE_HELD),
                   g15driver.MEMORY_1: g15actions.ActionBinding(g15driver.MEMORY_1, [g15driver.G_KEY_M1],
                                                                g15driver.KEY_STATE_UP),
                   g15driver.MEMORY_2: g15actions.ActionBinding(g15driver.MEMORY_2, [g15driver.G_KEY_M2],
                                                                g15driver.KEY_STATE_UP),
                   g15driver.MEMORY_3: g15actions.ActionBinding(g15driver.MEMORY_3, [g15driver.G_KEY_M3],
                                                                g15driver.KEY_STATE_UP)
}
...
g19_action_keys = {g15driver.NEXT_SELECTION: g15actions.ActionBinding(g15driver.NEXT_SELECTION, [g15driver.G_KEY_DOWN],
                                                                      g15driver.KEY_STATE_DOWN),
                   g15driver.PREVIOUS_SELECTION: g15actions.ActionBinding(g15driver.PREVIOUS_SELECTION,
                                                                          [g15driver.G_KEY_UP],
                                                                          g15driver.KEY_STATE_DOWN),
                   g15driver.SELECT: g15actions.ActionBinding(g15driver.SELECT, [g15driver.G_KEY_OK],
                                                              g15driver.KEY_STATE_UP),
                   g15driver.MENU: g15actions.ActionBinding(g15driver.MENU, [g15driver.G_KEY_MENU],
                                                            g15driver.KEY_STATE_UP),
                   g15driver.CLEAR: g15actions.ActionBinding(g15driver.CLEAR, [g15driver.G_KEY_BACK],
                                                             g15driver.KEY_STATE_UP),
                   g15driver.VIEW: g15actions.ActionBinding(g15driver.VIEW, [g15driver.G_KEY_SETTINGS],
                                                            g15driver.KEY_STATE_UP),
                   g15driver.NEXT_PAGE: g15actions.ActionBinding(g15driver.NEXT_PAGE, [g15driver.G_KEY_RIGHT],
                                                                 g15driver.KEY_STATE_UP),
                   g15driver.PREVIOUS_PAGE: g15actions.ActionBinding(g15driver.PREVIOUS_PAGE, [g15driver.G_KEY_LEFT],
                                                                     g15driver.KEY_STATE_UP),
                   g15driver.MEMORY_1: g15actions.ActionBinding(g15driver.MEMORY_1, [g15driver.G_KEY_M1],
                                                                g15driver.KEY_STATE_UP),
                   g15driver.MEMORY_2: g15actions.ActionBinding(g15driver.MEMORY_2, [g15driver.G_KEY_M2],
...
mx5500_action_keys = {
g15driver.NEXT_SELECTION: g15actions.ActionBinding(g15driver.NEXT_SELECTION, [g15driver.G_KEY_DOWN],
                                                   g15driver.KEY_STATE_UP),
g15driver.PREVIOUS_SELECTION: g15actions.ActionBinding(g15driver.PREVIOUS_SELECTION, [g15driver.G_KEY_UP],
                                                       g15driver.KEY_STATE_UP),
...
g15driver.CLEAR: g15actions.ActionBinding(g15driver.CLEAR, [g15driver.G_KEY_UP, g15driver.G_KEY_DOWN],
                                          g15driver.KEY_STATE_HELD),
g15driver.VIEW: g15actions.ActionBinding(g15driver.VIEW, [g15driver.G_KEY_UP, g15driver.G_KEY_DOWN],
                                         g15driver.KEY_STATE_UP)
}
...
class DeviceInfo():
    ...
    def __init__(self, model_id, usb_id_list, controls_usb_id_list, key_layout, bpp, lcd_size, macros, model_fullname,
                 action_keys):
        """
    ...
    def __repr__(self):
        return "DeviceInfo [%s/%s] model: %s (%s). Has a %d BPP screen of %dx%d. " % \
               (str(self.usb_id_list), str(self.controls_usb_id_list), self.model_id, self.model_fullname, self.bpp,
                self.lcd_size[0], self.lcd_size[1])
...
class Device():
    ...
    def __repr__(self):
        ...
        return "Device [%s] %s model: %s (%s) on USB ID %s:%s. Has a %d BPP screen of %dx%d. " % \
               (str(self.usb_device), self.uid, self.model_id, self.model_fullname, usb_str, usb_str2, self.bpp, sz1,
                sz2)
...
DeviceInfo(g15driver.MODEL_G11, (0x046d, 0xc225), None, g11_key_layout, 0, ( 0, 0 ), True, _("Logitech G11 Keyboard"),
           g11_action_keys)
DeviceInfo(g15driver.MODEL_G19, (0x046d, 0xc229), None, g19_key_layout, 16, ( 320, 240 ), True,
           _("Logitech G19 Gaming Keyboard"), g19_action_keys)
DeviceInfo(g15driver.MODEL_G15_V1, (0x046d, 0xc221), (0x046d, 0xc222), g15v1_key_layout, 1, ( 160, 43 ), True,
           _("Logitech G15 Gaming Keyboard (version 1)"), g15_action_keys)
DeviceInfo(g15driver.MODEL_G15_V2, (0x046d, 0xc227), None, g15v2_key_layout, 1, ( 160, 43 ), True,
           _("Logitech G15 Gaming Keyboard (version 2)"), g15_action_keys)
DeviceInfo(g15driver.MODEL_G13, (0x046d, 0xc21c), None, g13_key_layout, 1, ( 160, 43 ), True,
           _("Logitech G13 Advanced Gameboard"), g15_action_keys)
DeviceInfo(g15driver.MODEL_G510, [(0x046d, 0xc22d),
                                  (0x046d, 0xc22e)], None, g510_key_layout, 1, ( 160, 43 ), True,
           _("Logitech G510 Keyboard"), g15_action_keys)
DeviceInfo(g15driver.MODEL_Z10, (0x046d, 0x0a07), None, z10_key_layout, 1, ( 160, 43 ), False,
           _("Logitech Z10 Speakers"), z10_action_keys)
DeviceInfo(g15driver.MODEL_G110, (0x046d, 0xc22b), None, g110_key_layout, 0, ( 0, 0 ), True,
           _("Logitech G110 Keyboard"), g110_action_keys)
DeviceInfo(g15driver.MODEL_GAMEPANEL, (0x046d, 0xc251), None, g15v1_key_layout, 1, ( 160, 43 ), True,
           _("Logitech GamePanel"), g15_action_keys)
DeviceInfo(g15driver.MODEL_G930, (0x046d, 0xa1f), None, g930_key_layout, 0, ( 0, 0 ), True,
           _("Logitech G930 Headphones"), {})
...
DeviceInfo(g15driver.MODEL_MX5500, (0x0000, 0x0000), (0x0000, 0x0000), mx5500_key_layout, 1, ( 136, 32 ), False,
           _("Logitech MX5500"), mx5500_action_keys)
